...
def parse_args():
    ...
    parser.add_argument('--img_path', default='./flowers/test/101/image_07988.jpg', type=str, help='set the image path')
    ...
    parser.add_argument('--ckpt_path', default='ckpt.pth', type=str, help='set the ckpt path')
