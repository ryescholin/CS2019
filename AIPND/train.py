...
def parse_args():
    ...
    parser.add_argument('--model', default='resnet', type=str, help='choose the model architecture')
    ...
    parser.add_argument('--ckpt_name', default='ckpt.pth', type=str, help='set the save name')
...
def main():
    ...
    print('Save the trained model to {}'.format(ckpt_name))
